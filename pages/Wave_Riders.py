...
st.set_page_config(page_title=CLAAN, page_icon=":ocean:", layout="wide")
...
def check_password():
    ...
    def password_entered():
        ...
        if st.session_state["password"] == st.secrets.passwords.get("wave_riders"):
...
if "db" not in st.session_state:
    ...
    st.session_state.col = st.session_state.db["wave_riders"]
